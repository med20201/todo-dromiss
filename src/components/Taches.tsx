...
const mockData = {
  tasks: [
    { id: '1', title: 'Faire le design', status: 'completed', assigned_to: '101', priority: 'high', due_date: '2025-08-01' },
    { id: '2', title: 'Développer backend', status: 'in-progress', assigned_to: '102' },
    { id: '3', title: 'Tester application', status: 'todo', assigned_to: '103' },
    { id: '4', title: 'Déployer sur serveur', status: 'todo', assigned_to: '101', priority: 'high' },
    { id: '5', title: 'Rédiger documentation', status: 'in-progress', assigned_to: '102' },
  ],
  users: [
    { id: '101', name: 'Alice Dupont' },
    { id: '102', name: 'Bob Martin' },
    { id: '103', name: 'Claire Durand' },
  ],
  projects: [
    { id: 'p1', name: 'Projet A', status: 'active', description: 'Un projet important', progress: 70, teamMembers: ['101', '102'] },
    { id: 'p2', name: 'Projet B', status: 'planning', description: 'Phase de planification', progress: 10, teamMembers: ['103'] },
  ],
};
...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    // بدل fetch ببيانات ثابتة
    setTasks(mockData.tasks);
    setTeamMembers(mockData.users);
